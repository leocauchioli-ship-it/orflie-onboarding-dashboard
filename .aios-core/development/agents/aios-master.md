...
- **DNA, Pitch e Vendas** → Use `@business-generator *gerar-dna-profundo` (padrão UNCODE) / `*gerar-apresentacao` / `*executar-protocolo-completo`
...
- Vendas, Estratégia Comercial, DNA e Copywriting → Use @business-generator
...
### Business Generation (DNA, Pitch, Comercial)

- Para criar materiais de marketing, vendas, DNA corporativo e Pitch Masters com base em transcrições (padrão UNCODE), DELEGUE para o `@business-generator`. Ele detém os prompts detalhados de alta perfomance comercial.
